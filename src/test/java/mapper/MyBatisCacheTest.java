...
public class MyBatisCacheTest {
    ...
    public void testCacheWithDiffererntNamespace() throws Exception {
        ...
        studentMapper3.updateStudentName("特色一班",1);
        sqlSession3.commit();
    ...
    public void testCacheWithDelete() throws Exception {
        ...
        System.out.println("studentMapper读取数据: " + studentMapper.getStudentByName("明明"));
        sqlSession1.close();
        System.out.println("studentMapper2读取数据: " + studentMapper2.getStudentByName("明明"));

        System.out.println("删除了" + studentMapper3.deleteStudentName("明明") + "个学生");
        sqlSession3.commit();
        System.out.println("studentMapper2读取数据: " + studentMapper2.getStudentByName("明明"));
    }
